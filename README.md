...
> This project was vibe coded — built with AI assistance (Claude) rather than written by hand line-by-line. It's tested and the behavior is verified, but flagging that up front for transparency.
